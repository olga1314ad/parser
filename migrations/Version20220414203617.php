 ...
 */
final class Version20220414203617 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sales_notes CHANGE name name VARCHAR(50) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE sales_notes CHANGE name name VARCHAR(20) NOT NULL');
    }
}
