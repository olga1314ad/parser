 ...
 */
final class Version20220413223742 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE offer (id INT AUTO_INCREMENT NOT NULL, currency_id INT NOT NULL, delivery_option_id INT NOT NULL, category_id INT NOT NULL, vendor_id INT NOT NULL, url VARCHAR(150) NOT NULL, price INT NOT NULL, store TINYINT(1) NOT NULL, pickup TINYINT(1) NOT NULL, delivery TINYINT(1) NOT NULL, model VARCHAR(255) NOT NULL, type_prefix VARCHAR(100) NOT NULL, description LONGTEXT NOT NULL, vendor_code VARCHAR(20) NOT NULL, barcode VARCHAR(20) NOT NULL, INDEX IDX_29D6873E38248176 (currency_id), INDEX IDX_29D6873EE3A151FD (delivery_option_id), INDEX IDX_29D6873E12469DE2 (category_id), INDEX IDX_29D6873EF603EE73 (vendor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE offer_sales_notes (offer_id INT NOT NULL, sales_notes_id INT NOT NULL, INDEX IDX_767DAB3453C674EE (offer_id), INDEX IDX_767DAB34B1EA6D72 (sales_notes_id), PRIMARY KEY(offer_id, sales_notes_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE sales_notes (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(20) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offer_sales_notes DROP FOREIGN KEY FK_767DAB3453C674EE');
        ...
        $this->addSql('ALTER TABLE offer_sales_notes DROP FOREIGN KEY FK_767DAB34B1EA6D72');
